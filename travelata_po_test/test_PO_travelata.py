...
class HomePage():
    ...
    def search_for_destination(self, destination_text):
        ...
        market_banner = WebDriverWait(self.driver, 10).until(
            EC.presence_of_element_located(self.marketing_banner_locator)
        )
        market_banner.click()

        # self.driver.implicitly_wait(10)
        # destination_obj = self.driver.find_element(self.destination_locator)
        destination_obj = WebDriverWait(self.driver, 10).until(
        ...
        start_search = WebDriverWait(self.driver, 10).until(
            EC.presence_of_element_located(self.start_search_locator)
        )
        start_search.click()
